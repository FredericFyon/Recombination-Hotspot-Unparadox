...
int main()
{
    ...
    int Nloc = 10;                                       //number of target loci
    int Ngen = 100000;                                  //total number of generations
    int Nit = 2;                                        //number of iterations
    ...
    double f = 0.3;                                     //fitness cost of the absence of Crossing-Over (CO)
    double mu_A = 0.000001;                            //mutation rate on PRDM9 locus
    ...
    for(int it = 1; it < Nit; ++it)
    {
        ...
        fileResults << "C:\\Users\\Fred\\Dropbox\\Fyon\\RecombinationHotspost\\Project 1 - Recombination Hotspot Dynamics with Mutation\\Finite Population Stochastic Model\\ManyTarget Stochastic Model\\probCOFinal_It" << it << "_c" << c << "_f" << f << "_Npop" << Npop << "_Nloc" << Nloc << "_muA" << mu_A << "_muB" << mu_B << "_r" << r << ".dat";
        ...
        fileResultsPRDM9 << "C:\\Users\\Fred\\Dropbox\\Fyon\\RecombinationHotspost\\Project 1 - Recombination Hotspot Dynamics with Mutation\\Finite Population Stochastic Model\\ManyTarget Stochastic Model\\freqPRDM9Final_It" << it << "_c" << c << "_f" << f << "_Npop" << Npop << "_Nloc" << Nloc << "_muA" << mu_A << "_muB" << mu_B << "_r" << r << ".dat";
        ...
        fileResultsLoc << "C:\\Users\\Fred\\Dropbox\\Fyon\\RecombinationHotspost\\Project 1 - Recombination Hotspot Dynamics with Mutation\\Finite Population Stochastic Model\\ManyTarget Stochastic Model\\freqLocFinal_It" << it << "_c" << c << "_f" << f << "_Npop" << Npop << "_Nloc" << Nloc << "_muA" << mu_A << "_muB" << mu_B << "_r" << r << ".dat";
