...
vector<vector<vector<double> > > LifeCycle(vector<vector<vector<double> > > Pop, double R, double mu_A, double mu_B, double b, double c, double f, int Npop, int Nloc, mt19937 mt)
{
    ...
    for(int i = 0; i < Npop; ++i)
    {
        ...
        {                                                                                   //accepted
            ...
            vector<vector<vector<double> > > MeiosisPar1 = Meiosis(Pop[Parent1],R,mu_A,mu_B,b,c,f,Nloc,mt,Stats);    //Running the meiosis of parent 1
        ...
        while(Accepted2 == false)
        {
            ...
            vector<vector<vector<double> > > MeiosisPar2 = Meiosis(Pop[Parent2],R,mu_A,mu_B,b,c,f,Nloc,mt,Stats);
